...
// 关闭设备
extern "C" DWORD __stdcall CAN_DeviceClose(DWORD dwDeviceHandle);
// 启动CAN
extern "C" DWORD __stdcall CAN_ChannelStart(DWORD dwDeviceHandle, DWORD dwChannel, PCAN_InitConfig pInitConfig);
// 停止CAN
extern "C" DWORD __stdcall CAN_ChannelStop(DWORD dwDeviceHandle, DWORD dwChannel);
// 获取设备信息
extern "C" DWORD __stdcall CAN_GetDeviceInfo(DWORD dwDeviceHandle, PCAN_DeviceInformation pInfo);
// 获取CAN错误信息
extern "C" DWORD __stdcall CAN_GetErrorInfo(DWORD dwDeviceHandle, DWORD dwChannel,PCAN_ErrorInformation pErr);
// 读EEPROM
extern "C" DWORD __stdcall CAN_ReadEEPROM(DWORD dwDeviceHandle, WORD dwAddr, PBYTE pBuff, WORD nLen);
// 写EEPROM
extern "C" DWORD __stdcall CAN_WriteEEPROM(DWORD dwDeviceHandle, WORD dwAddr, PBYTE pBuff, WORD nLen);
// 发送数据
extern "C" ULONG __stdcall CAN_ChannelSend(DWORD dwDeviceHandle, DWORD dwChannel, PCAN_DataFrame pSend, ULONG nCount);
// 从接收缓冲区中读数据
extern "C" ULONG __stdcall CAN_ChannelReceive(DWORD dwDeviceHandle, DWORD dwChannel, PCAN_DataFrame pReceive, ULONG nCount, INT nWaitTime=-1);
// 获取接收缓冲区帧数
extern "C" ULONG __stdcall CAN_GetReceiveCount(DWORD dwDeviceHandle, DWORD dwChannel);
// 清空接收缓冲区
extern "C" DWORD __stdcall CAN_ClearReceiveBuffer(DWORD dwDeviceHandle, DWORD dwChannel);
//读寄存器
extern "C" DWORD __stdcall CAN_ReadRegister(DWORD dwDeviceHandle, DWORD dwChannel,DWORD dwAddr, PBYTE pBuff, WORD nLen);
//写寄存器
extern "C" DWORD __stdcall CAN_WriteRegister(DWORD dwDeviceHandle, DWORD dwChannel,DWORD dwAddr, PBYTE pBuff, WORD nLen);
// 获取参数
extern "C" DWORD __stdcall CAN_GetParam(DWORD dwDeviceHandle, DWORD dwChannel, DWORD dwParamType, PVOID pData);
// 设置参数
