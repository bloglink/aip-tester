...
/**
  ...
  * @retval None
  */
void Test::showItem(QString item)
{
...
/**
  ...
  * @retval None
  */
void Test::showJudge(QString judge)
{
...
/**
  ...
  * @retval None
  */
void Test::showWaveItem(QByteArray msg)
{
...
/**
  ...
  * @retval None
  */
void Test::showWaveByte(QByteArray msg)
{
    for (int i=0; i<wave.size(); i++) {
...
/**
  ...
  * @retval None
  */
void Test::showWaveTest(QByteArray msg)
{
    for (int i=0; i<wave.size(); i++) {
...
/**
  ...
  * @retval None
  */
void Test::showTemperature(QByteArray msg)
{
...
/**
  ...
  * @retval None
  */
void Test::showStation(QByteArray msg)
{
...
/**
  ...
  * @retval None
  */
void Test::readMessage(quint16 addr, quint16 cmd, QByteArray msg)
{
...
/**
  ...
  * @retval None
  */
void Test::initItems(QByteArray msg)
{
...
/**
  ...
  * @retval None
  */
void Test::hideEvent(QHideEvent *)
{
    saveSettings();
}
/*********************************END OF FILE**********************************/
