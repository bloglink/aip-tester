...
/* Includes ------------------------------------------------------------------*/
#include "MotorType.h"
#include "ui_MotorType.h"
/**
  * @brief  Initializes
  * @param  *parent:parent widget
  * @retval None
  */
MotorType::MotorType(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::MotorType)
{
    ui->setupUi(this);
...
/**
  ...
  * @retval None
  */
void MotorType::judgeButton(int id)
{
    switch (id) {
    case 0:
...
void MotorType::initSettings()
{
    ...
    ui->BoxType->setCurrentIndex(c_settings->value("MotorType","0").toInt());
...
void MotorType::saveSettings()
{
    ...
    c_settings->setValue("MotorType",QString::number(ui->BoxType->currentIndex()));
...
/**
  ...
  * @retval None
  */
void MotorType::selectWireColor(int row, int column)
{
    ui->WinType->setCurrentIndex(0);
...
/**
  ...
  * @retval None
  */
void MotorType::showAvailableItem(int, int)
{
...
/**
  ...
  * @retval None
  */
void MotorType::selectItemToTest(int row, int column)
{
...
/**
  ...
  * @retval None
  */
void MotorType::showEvent(QShowEvent *)
{
    initTypes();
    initItems();
    initSettings();
...
/**
  ...
  * @retval None
  */
void MotorType::hideEvent(QHideEvent *)
{
    saveSettings();
}
/*********************************END OF FILE**********************************/
