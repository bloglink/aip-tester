...
void LQSnowflake::setMachineId(quint64 id)
{
    machineId = id;
    machineId = machineId & machineMask;
}

void LQSnowflake::setDataCenterId(quint64 id)
{
    datacenterId = id;
    datacenterId = datacenterId & datacenterMask;
}

quint64 LQSnowflake::getTimestamp()
{
    return QDateTime::currentDateTime().toMSecsSinceEpoch();
}

quint64 LQSnowflake::getNextTimestamp(quint64 lastTimestamp)
{
