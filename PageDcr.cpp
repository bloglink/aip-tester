...
/**
  ...
  * @retval None
  */
void PageDcr::TestStatus(QByteArray msg)
{
    if (!isCheckOk) {
        isCheckOk = true;
...
/**
  ...
  * @retval None
  */
void PageDcr::TestStart(quint8 pos)
{
    if (Testing)
        return;
    QByteArray msg;
 ...
 * brief:       修改显示方式
*******************************************************************************/
void PageDcr::TestResult(QByteArray msg)
{
 ...
 * brief:      计算温度补偿
*******************************************************************************/
double PageDcr::TestOffset(double t, quint8 num)
{
    double temp;
    double res = 0;
 ...
 * brief:      去除超时处理
*******************************************************************************/
bool PageDcr::TestTimeOut(quint16 t)
{
    TimeOut = 0;
    while (Testing) {
        TestDelay(10);
